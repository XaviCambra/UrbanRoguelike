...
public class Module_Animation : MonoBehaviour
{
    ...
    public float Play(string l_ParameterName, int l_Value)
    {
    ...
    public float Play(string l_ParameterName, float l_Value)
    {
    ...
    public float Play(string l_ParameterName, bool l_Value)
    {
    ...
    public float Play(string l_ParameterName)
    {
